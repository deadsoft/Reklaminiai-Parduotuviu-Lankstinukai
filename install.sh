...
cp -f BeautifulSoup.py linkparser.py pdf2images.py oldpdfdeleter.py deadprogram.py updater.py main.py gui.py imagedeleter.py helpfile.py /usr/lib/deadprogram
