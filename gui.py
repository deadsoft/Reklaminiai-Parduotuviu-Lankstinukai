...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.intbuttonaibe.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.intbuttonFRESH_MARKET.setMinimumSize(QtCore.QSize(110, 0))
        ...
        self.intbuttonSenukai.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.horizontalLayout_2.addWidget(self.intbuttonSenukai)
        ...
        self.intbuttonMoki_Vezi.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.horizontalLayout_2.addWidget(self.intbuttonMoki_Vezi)
        ...
        self.intbuttonJysk.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.horizontalLayout_2.addWidget(self.intbuttonJysk)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_5.setItemText(0, _translate("MainWindow", "Aibe", None))
        self.comboBox_7.setItemText(0, _translate("MainWindow", "FRESH_MARKET", None))
        self.comboBox_8.setItemText(0, _translate("MainWindow", "Senukai", None))
        self.comboBox_9.setItemText(0, _translate("MainWindow", "Moki_Vezi", None))
        ...
        self.intbuttonaibe.setText(_translate("MainWindow", "Aibe", None))
        self.intbuttonFRESH_MARKET.setText(_translate("MainWindow", "FRESH_MARKET", None))
        self.intbuttonSenukai.setText(_translate("MainWindow", "Senukai", None))
        self.intbuttonMoki_Vezi.setText(_translate("MainWindow", "Moki_Vezi", None))
        ...
        self.checkboxAibe.setText(_translate("MainWindow", "Aibe", None))
        self.checkboxFRESH_MARKET.setText(_translate("MainWindow", "FRESH_MARKET", None))
        self.checkboxSenukai.setText(_translate("MainWindow", "Senukai", None))
        self.checkboxMoki_Vezi.setText(_translate("MainWindow", "Moki_Vezi", None))
